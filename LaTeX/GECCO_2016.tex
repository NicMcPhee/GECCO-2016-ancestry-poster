...
\begin{figure*}[tb]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{../Figures/run5_RBM_color_filtered_and_full.pdf}
	\end{center}
	\caption{Unfiltered (left) and filtered (right) versions of a successful lexicase run, both with the same color map.}
	\label{fig:lexRun5FilteredAndFull}
\end{figure*}
...
\begin{figure*}[tb]
	\begin{center}
		\includegraphics[height=0.95\textheight]{../Figures/runs_1_0_90_filtered.pdf}
	\end{center}
	\caption{Filtered ancestry graphs of three successful runs (1, 0, and 90), all with the same color map.}
	\label{fig:runs1:0:90:filtered}
\end{figure*}

\begin{figure*}[tb]
	\begin{center}
		\includegraphics[height=0.95\textheight]{../Figures/runs_1_99_6_RBM_color_filtered.pdf}
	\end{center}
...
\begin{figure*}[tb]
	\begin{center}
		\includegraphics[width=0.7\textwidth]{../Figures/runs_5_1_99_6_0_90_RBM_color_filtered.pdf}
	\end{center}
	\caption{Filtered ancestry graphs of six successful runs (5, 1, 99, 6, 0, and 90), all with the same color map.}
	\label{fig:runs5:1:99:6:0:90:filtered}
\end{figure*}

\begin{figure*}[tb]
	\begin{center}
		\includegraphics[width=0.6\textwidth]{../Figures/runs_5_1_99_6_RBM_color_filtered.pdf}
	\end{center}
	\caption{Filtered ancestry graphs of 4 successful runs (5, 1, 99, and 6), all with the same color map.}
	\label{fig:runs5:1:99:6:filtered}
\end{figure*}
...
%\begin{figure*}[tb]
%	\begin{center}
%		\includegraphics[width=0.5\textwidth]{../Figures/runs_92_2_1_99_dual_color_full.pdf}
%	\end{center}
